							...
							<form action="">
								...
								<div class="form-group">
									...
									<div class="grid">
										<div class="col-2-3">
											<div class="controls">
												<input type="text" id="street" class="floatLabel"
													name="street"> <label for="street">Street</label>
											</div>
										</div>
										<div class="col-1-3">
											<div class="controls">
												<input type="number" id="street-number" class="floatLabel"
													name="street-number"> <label for="street-number">Number</label>
											</div>
										</div>
									</div>
									<div class="grid">
										...
										<div class="col-1-3">
											<div class="controls">
												<input type="text" id="post-code" class="floatLabel"
													name="post-code"> <label for="post-code">Post
													Code</label>
											</div>
										</div>
									</div>
									<div class="controls">
										<input type="text" id="country" class="floatLabel"
											name="country"> <label for="country">Country</label>
									</div>
								</div>
								<!--  Details -->
								<div class="form-group">
										...
										<div class="col-1-4 col-1-4-sm">
											<div class="controls">
												<input type="date" id="depart" class="floatLabel"
													...
													class="fa fa-calendar"></i>&nbsp;&nbsp;Depart</label>
											</div>
										</div>
									</div>
									<div class="grid">
									...
									<div class="grid">
										<p class="info-text">Please describe your needs e.g. Extra
											beds, children's cots</p>
										<br>
										<div class="controls">
						...
						<div role="tabpanel" class="col-lg-9  tab-pane fade" id="day-2">
							...
							<div class="row schedule-item">
								...
								<div class="col-md-10">
									...
									<p>Maiores dignissimos neque qui cum accusantium ut sit
										sint inventore.</p>
								</div>
							</div>
							...
							<div class="row schedule-item">
								...
								<div class="col-md-10">
									...
									<p>Veniam accusantium laborum nihil eos eaque accusantium
										aspernatur.</p>
								</div>
							</div>
							...
							<div class="row schedule-item">
								...
								<div class="col-md-10">
									...
									<h4>
										Qui non qui vel amet culpa sequi. <span>Jack
											Christiansen</span>
									</h4>
							...
							<div class="row schedule-item">
								...
								<div class="col-md-10">
									...
									<h4>
										Quos ratione neque expedita asperiores. <span>Alejandrin
											Littel</span>
									</h4>
									<p>Eligendi quo eveniet est nobis et ad temporibus odio
										quo.</p>
								</div>
							</div>
							...
							<div class="row schedule-item">
								...
								<div class="col-md-10">
									...
									<p>Voluptatem et alias dolorum est aut sit enim neque
										veritatis.</p>
								</div>
							</div>
